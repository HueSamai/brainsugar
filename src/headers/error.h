...
#define ERR_MACROEXISTS "a macro with the name '%s' already exists!\npotential fixes:\n\t- give your macros/sections unique names\n\t- make sure a macro and a section don't have the same name\n\t- make sure a library you are using doesn't have a macro/section with that name already"
